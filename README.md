About python-paragraph-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-paragraph-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Othoz/paragraph
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8463&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-paragraph-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-paragraph` can be installed with `conda`:
...
```
mamba install python-paragraph
```

It is possible to list all of the versions of `python-paragraph` available on your platform with `conda`:
...
```
mamba search python-paragraph --channel conda-forge
```
...
mamba repoquery search python-paragraph --channel conda-forge

# List packages depending on `python-paragraph`:
mamba repoquery whoneeds python-paragraph --channel conda-forge

# List dependencies of `python-paragraph`:
mamba repoquery depends python-paragraph --channel conda-forge
```
